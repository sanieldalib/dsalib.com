  ...
  return (
    ...
    >
      <a href="https://github.com/sanieldalib" target="_blank">
        <div className="hover:bg-gray-100 text-green-600 hover:text-green-900 dark:text-gray-500 dark:hover:bg-gray-800 dark:hover:text-green-700 px-1 py-1 rounded-md text-md font-medium cursor-pointer">
          <FaGithub />
        </div>
      </a>
